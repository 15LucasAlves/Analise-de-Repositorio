# Trabalho 1 - Tecnicas de Desenvolvimento de VideoJogos
...
Projeto / Repositorio de escolha: https://github.com/crlimacastro/just-chess/tree/master
...
ChessGameManagerState.cs
	...
	ChessGameManagerStateMachine.cs
		...
		If “Game state != NULL” ele da exit.
...
Scenes
	...
	SceneMainMenu.cs
		...
		Create the Main menu background and adds the “Play”, “Load” ,“Quit” buttons.
	Makes it possible to click the buttons.
...
Também tem a função para um player poder desistir da partida. Existe uma função para mostrar os moves possíveis que não deixariam o próprio jogador em cheque. Por último, ele guarda o estado do jogo num ficheiro binário.
